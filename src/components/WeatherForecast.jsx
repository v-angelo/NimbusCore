      ...
      <div className="space-y-4">
        ...
        {dailyItems.map((item, index) => {
          ...
          return (
            <article
              key={index}
              className="group flex cursor-pointer items-center justify-between rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm transition-all duration-300 hover:bg-white/10"
            >
              {/* forecast data */}
