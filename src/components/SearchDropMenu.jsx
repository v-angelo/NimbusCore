...
function SearchDropMenu() {
  return (
    <article className="absolute top-full right-0 left-0 z-50 mt-3 overflow-hidden rounded-2xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-lg">
      ...
      {/*  */}
      <button className="group flex w-full cursor-pointer items-center justify-between border-b border-white/10 px-6 py-4 text-left transition-all duration-200 last:border-b-0 hover:bg-white/10">
